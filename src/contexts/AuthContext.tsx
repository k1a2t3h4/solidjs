...
export const AuthProvider = (props: { children: JSX.Element }) => {
  ...
  const test = async (
    ...
    try {
      ...
      const response = await fetch('https://server-production-3a02b.up.railway.app/bulk-test', {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      });
  ...
  const login = async (
    ...
    try {
      ...
      const response = await fetch('https://server-production-3a02b.up.railway.app/login', {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({
